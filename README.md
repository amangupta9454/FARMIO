    ...
    <div>FARMER-CONSUMER-MARKER - Farmer-Buyer Marketplace</div>
    <style>
        body {
        ...
        <section id="getting-started">
            ...
            <ol>
                <li>
                    ...
                    <pre><code>git clone https://github.com/amangupta9454/FARMER-CONSUMER-MARKER.git
cd FARMER-CONSUMER-MARKER</code></pre>
                </li>
                <li>
...
VITE_WEATHER_API_KEY=your_weather_api_key</code></pre>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>Frontend: <code>http youtube.com</code></li>
                    </ul>
                </li>
            </ol>
            <h3>Deployment</h3>
            <ul>
                <li><strong>Backend</strong>: Deploy on Render or Heroku, configure <code>.env</code>.</li>
                <li><strong>Frontend</strong>: Deploy on Netlify or Vercel, update <code>netlify.toml</code>.</li>
            </ul>
        </section>
        ...
        <section id="contact">
            ...
            <ul>
                ...
                <li><strong>LinkedIn</strong>: <a href="https://linkedin.com/in/amangupta9454">linkedin.com</a></li>
                <li><strong>GitHub</strong>: <a href="https://github.com/amangupta9454">github.com</a></li>
                <li><strong>Instagram</strong>: <a href="https://instagram.com/gupta_aman_9161">instagram.com</a></li>
            </ul>
        </section>
        ...
        <div class="footer">
            ...
            <div class="contact-links">
                ...
                <a href="https://linkedin.com/in/aman-gupta">LinkedIn</a>
                <a href="https://instagram.com/gupta_aman_9161">Instagram</a>
            </div>
        </div>
    </div>
